...
-- CreateEnum
CREATE TYPE "TaskTargetType" AS ENUM ('PROJECT', 'DOCUMENT', 'DOCUMENT_VERSION', 'SCENE', 'ENTITY', 'ASSET', 'APPROVAL', 'CONTACT');

-- CreateEnum
CREATE TYPE "ContactType" AS ENUM ('WRITER', 'PRODUCER', 'ARTIST', 'EXECUTIVE', 'AGENCY', 'MANAGEMENT', 'LEGAL', 'VENDOR', 'OTHER');

-- CreateEnum
CREATE TYPE "ContactStatus" AS ENUM ('NEW', 'ACTIVE', 'FOLLOW_UP', 'WAITING', 'DO_NOT_CONTACT', 'ARCHIVED');
